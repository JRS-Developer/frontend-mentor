...
const Hero = () => {
    return (
        <section className="flex mt-16 lg:pl-40 pl-6 flex-col-reverse md:flex-row bg-white pb-40">
            <div data-aos="fade-up" className="text-center md:text-left grid md:block justify-items-center pr-6">
                <h2 className="text-5xl sm:text-7xl leading-super-tight font-bold mt-8 md:mt-0">
